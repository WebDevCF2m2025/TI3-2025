      ...
      <form method="post" action="">
        <div class="mb-3">
          ...
          <div class="input-group input-group-lg">
            ...
            <input type="text" class="form-control bg-dark text-light border-light" id="login" name="login" required />
          </div>
        </div>
        <div class="mb-4">
          ...
          <div class="input-group input-group-lg">
            ...
            <input type="password" class="form-control bg-dark text-light border-light" id="password" name="password" required />
          </div>
        </div>
