            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 mb-2 mb-lg-0">
                        <div class="row">
                            <div class="col-lg-11">
                                <h1 class="text-center hero-title mb-3" data-aos="fade-up" data-aos-delay="100">Modification</h1>
                                <h4 class="text-center mb-3" data-aos="fade-up" data-aos-delay="100"><a href="./?pg=admin">Retour à l'administration</a></h4>
                            </div>
                            </div>
                        </div>
                ...
                ?>
                  ...
                  <form class="<?=$displayForm?>" action="" method="post" name="insertion">
                    <div class="mb-3">
                        ...
                        <input type="text" name="rue"  class="form-control" id="exampleFormControlInput1" value="<?=$localisation['rue']?> ">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">code postale</label>
                        <input type="text" name="codepostal"  class="form-control" id="exampleFormControlInput1" value="<?=$localisation['codepostal']?> ">
                    </div>

                    <div  lass="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">ville</label>
                        <input type="text" name="ville"  class="form-control" id="exampleFormControlInput1" value="<?=$localisation['ville']?> ">
                    </div>
                    ...
                    <input type="submit" class="bg-success text-center text-white p-2 rounded " value="Mettre a jour ">
                </form>
                    </div>
