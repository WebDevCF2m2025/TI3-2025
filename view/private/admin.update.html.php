        ...
        <footer class="footer pt-5 pb-5">
            <div class="container">
                <div class="row credits pt-3">
                    ...
                    <div class="col-xl-4 justify-content-start justify-content-xl-end quick-links d-flex flex-column flex-xl-row text-center text-xl-start gap-1">Distribué par<a href="https://themewagon.com" target="_blank">Le centre de formation CF2M</a></div>
                </div>
            </div>
        </footer>
        <!-- End Footer-->
