...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="bg-white p-4 rounded shadow-sm mb-5">
            ...
            <p>Bienvenue sur votre espace d'administration, <?php echo ($_SESSION['username']); ?></p>
            <hr>
            <h3 class="mb-4">Formulaire de mise à jour de la localisation "<?php echo ($localisation['nom']); ?>"</h3>
